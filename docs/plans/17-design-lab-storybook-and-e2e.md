...
7. **Storybook.** `TaskRow` shows Normal, Overdue, Completed, High Priority, Selected and
   ...
   runner.
8. **The §81 walkthrough** in [`docs/first-milestone-walkthrough.md`](../first-milestone-walkthrough.md)
...
| `docs/first-milestone-walkthrough.md` | **New.** The §81 click-path — at least one numbered step per bullet across all eight groups, with the seed each needs. This is what "demonstrable" means. |
