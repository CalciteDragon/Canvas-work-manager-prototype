...
- `docs/plans/25-dependency-repair.md`: diagnosis, review and execution evidence.
- `development.md`: replace stale dependency-blocker statements with current verification status.
- `docs/plans/25.6-root-archive-and-reachable-undo.md`, `docs/plans/25.7-completed-work-reflections.md`, `docs/plans/25-multi-page-projects-overhaul.md`: link current follow-up evidence, preserving historical observations.
