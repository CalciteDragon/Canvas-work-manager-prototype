<!-- completed-record id="2" closed="2026-08-26" summary="Zod contracts for every entity, input and the data.json document, exported from one entrypoint" -->
...
**Status:** done — plan: [02-contracts-package.md](02-contracts-package.md)
...
## Implementation plan — Slice 2 — Contracts package
