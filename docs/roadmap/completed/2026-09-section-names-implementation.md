<!-- completed-record id="U2" closed="2026-09-04" summary="Sections have a derived name with an optional title override, and a typed non-empty removal refusal" -->
...
**Status:** done — decision: [docs/decisions/2026-09-a-section-has-a-name.md](../../decisions/2026-09-a-section-has-a-name.md),
plan: [2026-09-section-names-implementation.md](2026-09-section-names-implementation.md).
...
## Implementation plan — Implementation plan — a section has a name
...
- `docs/guides/mcp-setup.md` — **`create_section` takes `title` too** (`inputs.ts:89`), and naming at
...
| `docs/guides/mcp-setup.md` | Document naming through create/update section |
