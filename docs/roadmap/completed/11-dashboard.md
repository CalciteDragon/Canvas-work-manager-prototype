<!-- completed-record id="11" closed="2026-08-28" summary="Dashboard widgets over one derived read, the AIProvider interface and the deterministic mock digest" -->
# Slice 11 — Dashboard
...
**Status:** done — plan: [11-dashboard.md](11-dashboard.md) — `/app`
...
entry](../../decisions/2026-08-dashboard-layout-and-content-split.md)): widgets come from
...
out of `AIProvider`** ([entry](../../decisions/2026-08-prototype-ai-scope-and-fun-fact.md)):
...
## Implementation plan — Slice 11 — Dashboard
