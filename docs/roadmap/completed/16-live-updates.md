<!-- completed-record id="16" closed="2026-08-30" summary="One Server-Sent Event after every committed activity record; feature stores refresh without a reload" -->
...
**Status:** done — original plan: [16-live-updates.md](16-live-updates.md), correctness follow-up: [16-live-updates-correctness-follow-up.md](16-live-updates-correctness-follow-up.md) — the follow-up closed derived-section propagation, first-connect/reconnect recovery, shared-store duplication, failed-first-load recovery, and quiet-read races found in the post-slice audit. One
...
"Last used" does not live-update ([entry](../../decisions/2026-08-live-events-ride-the-activity-record.md)).
...
([entry](../../decisions/2026-08-live-updates-are-http-only.md)).
...
## Implementation plan — Slice 16 — Live updates
...
| `docs/guides/mcp-setup.md` | One sentence: live updates are a property of the HTTP transport. |
