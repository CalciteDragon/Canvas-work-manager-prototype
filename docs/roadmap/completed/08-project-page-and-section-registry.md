<!-- completed-record id="8" closed="2026-08-27" summary="Project page, the section registry, ProjectSectionFrame, and the Rich Text and Task List sections" -->
...
## Implementation plan — Slice 8 — Project page + section registry
