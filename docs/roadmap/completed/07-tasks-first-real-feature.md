<!-- completed-record id="7" closed="2026-08-27" summary="Task list store, the TaskRow variants, the detail drawer and optimistic completion with revert" -->
# Slice 7 — Tasks: the first real feature

> **Completed record — frozen at closeout.** Status **done**, closed **2026-08-27**.
...
## Implementation plan — Slice 7 — Tasks: the first real feature
...
- `docs/roadmap/completed/07-tasks-first-real-feature.md` — keep this implementation checklist and review record current.
