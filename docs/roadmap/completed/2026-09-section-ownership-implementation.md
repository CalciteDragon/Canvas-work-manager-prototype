<!-- completed-record id="U1" closed="2026-09-01" summary="Container sections own their rows and views own nothing; four section MCP tools; schema version 2" -->
# Container sections own their rows

> **Completed record — frozen at closeout.** Status **done**, closed **2026-09-01**.
...
**Status:** done — decision: [docs/decisions/2026-09-sections-own-their-data.md](../../decisions/2026-09-sections-own-their-data.md),
plan: [2026-09-section-ownership-implementation.md](2026-09-section-ownership-implementation.md).
...
## Implementation plan — Implementation plan — container sections own their rows
...
- `docs/guides/mcp-setup.md` and `README.md` said "fourteen tools"; both now say eighteen and name
