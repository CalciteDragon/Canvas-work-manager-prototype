<!-- completed-record id="12" closed="2026-08-28" summary="The Ctrl/Cmd+Shift+D development panel, /prototype/state, the host rig endpoints, flags and friction notes" -->
# Slice 12 — Development panel

> **Completed record — frozen at closeout.** Status **done**, closed **2026-08-28**.
...
**Status:** done — plan: [12-development-panel.md](12-development-panel.md)
...
endpoints** ([decision](../../decisions/2026-08-latency-and-failure-live-in-the-client.md)):
...
demonstrable ([entry](../../decisions/2026-08-development-panel-surface.md), which also closes
...
## Implementation plan — Slice 12 — Development panel
