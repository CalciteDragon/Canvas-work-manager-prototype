<!-- completed-record id="6" closed="2026-08-27" summary="The gateway boundary, identity provider, design tokens, two themes and the app shell over HTTP" -->
...
## Implementation plan — Slice 6 — Gateway boundary + Angular shell
