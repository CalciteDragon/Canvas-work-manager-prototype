<!-- completed-record id="4" closed="2026-08-26" summary="Five deterministic seeds, three personas, the settable domain clock and the reset/seed CLI" -->
...
**Status:** done — plan: [04-seeds-personas-clock-reset.md](04-seeds-personas-clock-reset.md) — five deterministic seeds include isolated personas; atomic CLI reset/seed commands and a settable, lint-enforced domain clock are verified.
...
## Implementation plan — Slice 4 — Seeds, personas, clock, reset
...
- `docs/roadmap/completed/04-seeds-personas-clock-reset.md` — keep this plan current and record
