<!-- completed-record id="5" closed="2026-08-26" summary="Project, task and activity services over repository interfaces, exposed through the first §61 routes" -->
...
## Implementation plan — Slice 5 — Domain services + first HTTP API
