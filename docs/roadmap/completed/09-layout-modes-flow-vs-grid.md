<!-- completed-record id="9" closed="2026-08-28" summary="Flow and grid layouts with CDK drag-drop, View versus Edit Layout Mode, and the per-project layout flag" -->
...
## Implementation plan — Slice 9 — Layout modes: flow vs grid
...
- `docs/roadmap/completed/09-layout-modes-flow-vs-grid.md` — keep this plan and its review revisions current.
