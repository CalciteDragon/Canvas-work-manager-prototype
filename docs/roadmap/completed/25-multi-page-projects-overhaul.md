<!-- completed-record id="25.0" closed="2026-09-04" summary="Settled the root-workspace and subproject semantics, amended the spec and staged 25.1–25.8" -->
# Slices 25.0–25.8 — Multi-page projects overhaul (roadmap and 25.0)
...
[25-multi-page-projects-overhaul.md](25-multi-page-projects-overhaul.md),
decision:
[docs/decisions/2026-09-project-workspaces-and-subproject-work-units.md](../../decisions/2026-09-project-workspaces-and-subproject-work-units.md).
...
| 25.1 | Root/subproject model and persistent pages | 25.0 | done — plan: [25.1-owner-kinds-and-persistent-pages.md](25.1-owner-kinds-and-persistent-pages.md) |
| 25.2 | Page ownership through domain, API and MCP | 25.1 | done — plan: [25.2-page-aware-ownership.md](25.2-page-aware-ownership.md) |
| 25.3 | Secondary sidebar, Home and subproject canvas | 25.2 | done — plan: [25.3-workspace-shell-and-subproject-canvas.md](25.3-workspace-shell-and-subproject-canvas.md) |
| 25.4 | Home shortcuts | 25.3 | done — plan: [25.4-home-shortcuts.md](25.4-home-shortcuts.md) |
| 25.5 | Chronological Todos | 25.3 | done — plan: [25.5-chronological-todos.md](25.5-chronological-todos.md) |
| 25.6 | Root Archive and reachable undo | 25.3 | done — integrated/manual sign-off closed in 25.8: [25.6-root-archive-and-reachable-undo.md](25.6-root-archive-and-reachable-undo.md) |
| 25.7 | Completed-work reflections | 25.3 | done — integrated/manual sign-off closed in 25.8: [25.7-completed-work-reflections.md](25.7-completed-work-reflections.md) |
| 25.8 | Integrated acceptance and documentation closure | 25.4–25.7 | done — plan: [25.8-integrated-acceptance-and-documentation-closure.md](25.8-integrated-acceptance-and-documentation-closure.md) |
...
## Implementation plan — Multi-page projects overhaul — dependency-aware implementation roadmap
...
**Implementation plan:** [25.5-chronological-todos.md](25.5-chronological-todos.md) — **done**. The chronology, its two transports, the renderer and canonical section navigation all landed; the ordering, read-without-tab and one-way-completion choices are recorded in [the §78 entry](../../decisions/2026-09-todos-chronology-and-canonical-navigation.md).
...
- Wired host routes/services, the gateway, and canonical archive/restore tools in `packages/mcp-tools/src/tools/{projects,sections,tasks,reflections}.ts` with existing write permissions and activity attribution. Added the archive query to page tools and documented it.
- Implemented **new** `apps/web/src/app/features/projects/pages/archive-page.{ts,html,scss}`, `archive-page-store.ts`; adapted `archived-region/archived-region.{ts,html,scss}` into a presentational list and removed its direct-only store. Registered the page, removed the old footer, and added Open archive to project controls and nested navigation context.
- Fixed 25.4's canvas defect this slice's own canvas work sits on top of: `project-page-store.ts` now reads `shortcuts.list` only when the shell's `shortcutsAllowed` capability is true, including refresh/reconciliation paths; the domain refusal remains intact.

**Tests first:** `a work canvas requests no shortcut placements and shows no section error`; `all archived descendants listed once including blocked rows`; `independently archived child stays archived after ancestor restore`; `blocked restore gives canonical ancestor guidance`; `reactivation failure leaves controls blocked`; `hidden Archive can be reopened after removal`; `normal Home/Todos/shortcuts exclude archived content`; `cross-persona query rejected`; `restore permission enforced through MCP`.
