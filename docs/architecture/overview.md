...
- Keep each actor's reversible section, task and reflection writes in a scoped project
  history while Activity remains durable audit evidence even after an Add is undone.
