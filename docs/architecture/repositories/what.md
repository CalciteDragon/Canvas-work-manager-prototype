...
| `JsonCollectionRepository`, `Json*Repository` | `src/json-repositories.ts` | The twelve implementations over the provisional document, including `JsonOperationHistoryRepository` and `JsonOperationActionRepository` |
