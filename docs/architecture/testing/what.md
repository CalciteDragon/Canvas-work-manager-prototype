...
flowchart TB
  ...
  subgraph real["Run deliberately"]
    ...
    sb["Storybook: TaskRow, ProjectSectionFrame, canvas, history controls, recovery notice, navigation, pages, shortcuts, archive"]
